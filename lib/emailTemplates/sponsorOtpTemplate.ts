...
export function renderSponsorOtpEmail(options: SponsorOtpEmailOptions): string {
  const { companyName, otpCode, expiresInMinutes = 10 } = options;
...
<head>
  ...
  <title>รหัสชั่วคราวสำหรับเข้าสู่ระบบลงทะเบียนกลุ่มสปอนเซอร์ - TSRM</title>
</head>
    ...
    <tr>
      <td style="padding: 36px 32px;">
        ...
        <p style="font-size: 15px; color: #475569; line-height: 1.6;">
          คุณได้ทำการร้องขอรหัสชั่วคราว (OTP) เพื่อเข้าสู่ระบบลงทะเบียนและจัดการโควต้าผู้เข้าร่วมงานประชุม กรุณาใช้รหัสด้านล่างนี้เพื่อยืนยันตัวตน:
        </p>
        ...
        <div style="background-color: #f8fafc; border-left: 4px solid #3b82f6; padding: 14px 18px; border-radius: 6px; margin-bottom: 24px;">
          <p style="margin: 0; font-size: 13px; color: #475569; line-height: 1.5;">
            ...
            • รหัสนี้ใช้ได้เพียง 1 ครั้งเท่านั้น และจะขอใหม่ทุกครั้งที่เข้าสู่ระบบ<br/>
